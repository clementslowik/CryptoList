...
## Other
* [Funding Collector](https://github.com/clementslowik/funding-collector) — Collect crypto perpetual funding rates from 20 exchanges into normalized SQLite. MIT, stdlib + requests only.
